...
export default function Home() {
  return (
    <main className="landing">
      ...
      <footer className="landingFooter"><div className="brand">RAZOR<span>RECOVER</span></div><p>Autonomous revenue recovery with deterministic financial truth.</p><span>TEST MODE · NO REAL MONEY</span></footer>
    </main>
  );
}
