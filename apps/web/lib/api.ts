...
export async function api<T=any>(path:string,options:RequestInit={}):Promise<T>{
 const mutation=!!options.method&&options.method!=="GET";const headers:Record<string,string>={"Content-Type":"application/json",...((options.headers||{}) as Record<string,string>)};
